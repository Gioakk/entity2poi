...
(function () {
    ...
    var chooseIcon = function chooseIcon(entity) {
    	if (entity.type == "Taxi") {
    		icon = internalUrl('images/taxi_icon.png');
    	}
    	else if (entity.type == "observations"){
    		if (entity.Service2)
    			icon = internalUrl('images/temperature_icon.png');
    		else if (entity.Service3)
    			icon = internalUrl('images/pressure_icon.png');
    		else if (entity.Service1)
    			icon = internalUrl('images/particulate_icon.png');
    	} 
